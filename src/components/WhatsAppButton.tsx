...
const WHATSAPP_MESSAGE = 'Hi, I need website for my website'

function WhatsAppGlyph({ size = 26 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 448 512" fill="#ffffff" aria-hidden>
...
export function WhatsAppButton() {
  const href = `https://wa.me/${brand.phone.replace(/[^0-9]/g, '')}?text=${encodeURIComponent(WHATSAPP_MESSAGE)}`
